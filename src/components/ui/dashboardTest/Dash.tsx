...
const navigation = [
    { name: 'Główna', icon: HomeIcon, href: "/dashboard" },
    { name: 'Posiłki', icon: UsersIcon, href: "/dashboard/meals" },
    { name: 'Kalendarz', icon: CalendarIcon, href: "/dashboard/calendar" },
    { name: 'Płatności', icon: CreditCardIcon, href: "/dashboard/payments" },
    { name: 'Reports', icon: ChartPieIcon, href: "#reports" },
    { name: 'Użytkownicy', icon: UserGroupIcon, href: "/dashboard/users" },
    { name: 'Zdjęcia', icon: PhotoIcon, href: "/dashboard/images" },
]
